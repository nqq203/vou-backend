...
-- Insert mock data into the Voucher table
-- INSERT INTO Voucher (code, qr_code, voucher_name, voucher_price, image_url, expiration_date, description, type, id_item1, id_item2, id_item3, aim_coin, id_event)
-- VALUES ('LOOPY50K', 'example.com', 'Loopy giảm 50k', 50000, 'example.com', '2025-08-25', 'Giảm giá ngay 50k khi mua hàng tại shopee', 'online', 1, 2, 3, 100, 1),
-- ('Katinat', 'example.com', 'Katinat giảm 50k', 50000, 'example.com', '2025-08-25', 'Giảm giá 50k cho đơn hàng từ 30k từ Katinat', 'offline', 1, 2, NULL, 100, 2);